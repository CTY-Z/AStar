...
namespace CMAStar
{
    public struct CMLine
    {
        ...
        public CMLine(Vector2 pointOnLine, Vector2 pointPerpendicularToLine)
        {
        ...
        public void DrawWithGizmos(float length)
        {
            ...
            Gizmos.DrawLine(lineCentre - lineDir * length / 2.0f, lineCentre + lineDir * length / 2f);
        }
    }
}
